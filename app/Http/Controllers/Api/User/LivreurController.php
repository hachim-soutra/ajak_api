...
class LivreurController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->sendResponse(new LivreurCollection($Livreurs), 'Livreur list');
    }
    public function list()
    {
        $Livreurs = $this->Livreur->get_by_agency_list(auth()->user()->agence_id);
    ...
    {
        $Livreur = new LivreurResource($this->Livreur->show($id));
        return $this->sendResponse($Livreur, 'Livreur info');
    }
